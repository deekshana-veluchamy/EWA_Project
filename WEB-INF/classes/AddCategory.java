...
public class AddCategory extends HttpServlet {
	protected void doGet(HttpServletRequest request,
		...
		displayaddcategory(request, response, pw, false);
    }


    protected void displayaddcategory(HttpServletRequest request,
		...
		pw.print("<div class='container' style='margin-top: 20px;'>"
                ...
                + "<div class='panel-heading panel-heading-green' style='background: #22C125;color: whitesmoke;'>ADD CATEGORY</div>"
                + "</div>"
                + "<div class='container'>"
                + "<div class='form-horizontal'>"
                + "<div class='form-group'>"
                + "<label ID='Label1' CssClass='control-label col-md-2'>Category Name<label>"
                + "<div class='col-md-3'>"
                ...
                + "<div class='col-md-3'>"
                + "<input type='submit' class='btn btn-danger'  value='ADD CATEGORY' CssClass='col-xs-offset-0' border-style='none;' style='Width=303px; height:40px;font-size:15px; margin: 2rem; color:white; background: black;'></input>"
                + "</div>"
                + "</div>"
                + "</div>"
                + "</div>"
                ...
                + "<th scope='col' style='background-color: black; color: white;'>Category Name</th>"

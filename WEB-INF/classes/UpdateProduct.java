...
public class UpdateProduct extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		displayupdateproduct(request, response, pw, false);
    }


    protected void displayupdateproduct(HttpServletRequest request,
    ...
    pw.print("<form method='post' action='UpdateProductCode' enctype='multipart/form-data'>"
                + "<div class='container' style='margin-top: 20px;'>"


                + "<div class='panel panel-default'>"
                + "<div class='panel-heading panel-heading-green' style='background: #22C125;color: whitesmoke;'>UPDATE PRODUCT</div>"
                + "</div>"
                ...
                + "<div class='col-md-3'>"
                + "<input type='submit' class='btn btn-danger'  value='UPDATE PRODUCT' CssClass='col-xs-offset-0' border-style='none;' style='Width=303px; height:40px;font-size:15px; margin: 2rem; color:white; background: black;'></input>"
                + "</div>"
                + "</div>"
				+ "</div></div></form></div>");

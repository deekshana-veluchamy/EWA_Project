...
@WebServlet("/RetailerSignIn")

public class RetailerSignIn extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<div style='margin-top: 20px;'>"
	        + "<div class='media' style='margin-left: 540px;'>"
	           + "<div class='media-body' style='margin-top: 20px; padding-top: 20px;'>"
	               + "<h4 class='media-heading' style='font-family: Verdana; font-weight: 800; font-size:24px;'>Retailer Login</h4>"
	           + "</div></div></div>");
		if (error)
		...
		pw.print("<form action='RetailerSignUp'>"
				...
				+ "</form>" +"</div>"
				+ "<form action='RetailerSignIn' method='Post'>"
